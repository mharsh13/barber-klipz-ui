...
import '../BottomNavigationBarScreen/Backend/Provider/bottom_navigation_bar_base_model.dart';
import 'Backend/Provider/flickz_screen_base_model.dart';

class AddFlickzCaptionScreen extends ConsumerStatefulWidget {
  const AddFlickzCaptionScreen({super.key});

  @override
  ConsumerState<AddFlickzCaptionScreen> createState() =>
      _AddCaptionScreenState();
}

class _AddCaptionScreenState extends ConsumerState<AddFlickzCaptionScreen> {
  @override
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                      ...
                      child: FlicksView(
                        mediaUrl: bottomBaseModel.mediaFile!.path,
                      )),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
