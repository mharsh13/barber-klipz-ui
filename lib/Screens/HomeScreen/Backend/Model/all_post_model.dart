...
class AllPostModel {
  ...
  factory AllPostModel.fromMap(Map<String, dynamic> map) {
    return AllPostModel(
      id: map['id'] as String,
  ...
  factory AllPostModel.fromJson(String source) =>
      AllPostModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
