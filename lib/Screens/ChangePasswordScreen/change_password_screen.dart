import 'package:barber_klipz_ui/Screens/ChangePasswordScreen/Backend/Provider/change_password_base_model.dart';
...
class ChangePasswordScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final baseModel = ref.watch(changePasswordBaseModel);
            ...
            Expanded(
              child: Align(
                ...
                child: ButtonUtil.primaryButton(
                    text: "Continue", onPressed: () {}, screenUtil: screenUtil),
              ),
            )
          ],
        ),
